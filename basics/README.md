...
* [Content of current directory](#showcontent)
* [Return to user's Home directory](#return_to_home)
* [Content of current directory (long version)](#showlongcontent)
* [Content of current directory (include hidden files)](#showhidecontent)
* [Content of current directory (long, IDs numbers, hidden files)](#showlongidhide)
